...
const translations = {
    uk: {
        ...
        'home.description': 'Я займаюся фортепіано та постійно працюю над розвитком техніки й музичного мислення. Мій репертуар охоплює твори різних епох — від бароко до сучасності.',
    ...
    en: {
        ...
        'home.description': 'I study the piano and constantly work on developing my technique and musical thinking. My repertoire spans works from different eras — from baroque to the present day.',
    ...
    de: {
        ...
        'home.name': 'Yelyzaveta Shapovalova',
        'home.description': 'Ich beschäftige mich mit dem Klavier und arbeite ständig an der Entwicklung meiner Technik und meines musikalischen Denkens. Mein Repertoire umfasst Werke aus verschiedenen Epochen — vom Barock bis zur Gegenwart.',
